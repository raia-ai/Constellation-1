---
title: "QuickBooks® Online to QuickBooks Desktop® Conversion"
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/13838273"
tags: ["Contact Management"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "QuickBooks® Online to QuickBooks Desktop® Conversion This article outlines the data sets that can be migrated from QuickBooks® Online (QBO) to Desktop"
long_description: "QuickBooks® Online to QuickBooks Desktop® Conversion This article outlines the data sets that can be migrated from QuickBooks® Online (QBO) to Desktop (QBD). Almost all data points important to the financials can be migrated from the Online account(s) to QuickBooks® Desktop for U.S. Users ONLY. Please note that QuickBooks® Online does not provide a utility to migrate in Canada.  When exports are performed, we run the financial reports for the prior month, month to day, and prior year and to ensu"
---
...
_Please note that QuickBooks® Online does not provide a utility to migrate in Canada._  
...
 For a quote on QuickBooks® migration services please [contact us](http://www.emphasysre.com/contact) or call 888-661-6600 Option 1 
