...
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/13679693"
tags: ["Contact Management"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Creating Resources | Constellation1 Customer Hub Resources are the data tables of all the types of contacts entered in transactions"
long_description: "Creating Resources | Constellation1 Customer Hub Resources are the data tables of all the types of contacts entered in transactions. This article will outline how to add resources to your database, and a brief description of the fields. To add a new Resource, select Resources from the Set up menu Select a related category then select New and complete the required fields When creating or modifying transactions, check the applicable resource list first (Buyer, Seller, etc.) to see if that contact"
---
