...
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/17336141"
tags: ["Contact Management"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Constellation1 eSign June 2022 Release Notes Production Release: 30, 2022  RELEASE SUMMARY All-New Dashboard: Added a new dashboard to provide signing"
long_description: "Constellation1 eSign June 2022 Release Notes Production Release: 30, 2022  RELEASE SUMMARY All-New Dashboard: Added a new dashboard to provide signing session statistics and email delivery reports. Knowledge Base Authentication: Added new billing options. Sign Now or Later: Improved the workflow when the session creator is also a signer.  Form Fields: Made form fields required by default.  Form Field Settings: Updated the user interface.  Document Downloads: Improved the workflow when downloadin"
---
