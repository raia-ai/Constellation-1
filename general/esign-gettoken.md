---
title: "eSign - GetToken"
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/21150422"
tags: ["General Information"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "eSign - GetToken | Constellation1 Customer Hub Used to get an encryptedToken to make calls to the web service function"
long_description: "eSign - GetToken | Constellation1 Customer Hub Used to get an encryptedToken to make calls to the web service function. A new encryptedToken needs to be obtained prior to any call to the web service. URI GET rest/v1/gettoken/{salt} Returns – A RequestResponse containing the encryptedToken string in the ReturnValue property. The encryptedToken will be an encrypted value of your token. This will be sent with almost every call to the web service regarding user handling and session creation. (See Re"
---

# eSign - GetToken | Constellation1 Customer Hub
