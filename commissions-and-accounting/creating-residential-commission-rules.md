---
title: "Creating Residential Commission Rules"
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/13686441"
tags: ["Commissions & Accounting"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Creating Residential Commission Rules | Constellation1 Customer Hub Commission Rules takes some of the guess work out of the calculating, you can of c"
long_description: "Creating Residential Commission Rules | Constellation1 Customer Hub Commission Rules takes some of the guess work out of the calculating, you can of course overwrite the gross commission if it is a flat rate commission. Here are the steps. Name The unique label you assign this commission rule. (ex. 5eq%) Description A brief description of the residential commission rule. (ex. Selling 2.5%, Buying 2.5%) Up to & = Four different levels of property sale prices allow for more complex commission rule"
---

# Creating Residential Commission Rules | Constellation1 Customer Hub

Commission Rules takes some of the guess work out of the calculating, you can of course overwrite the gross commission if it is a flat rate commission. Here are the steps.
...
*   _Please note that if the rule you are editing is used in another transaction, that transaction will need to be re assigned a rule._
*   Select Edit icon make the necessary changes
*   Select Save

 ![](https://constellation1.na3.teamsupport.com/api/attachments/image/2472652/c08206c6-d74e-4812-9c1d-dee5791575ec.png) 
