...
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/20259415"
tags: ["Commissions & Accounting"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Accounting - Adjusting Under-collected Pre-split Deductions From the Current Calendar Year The purpose of this article is to show how to account for a"
long_description: "Accounting - Adjusting Under-collected Pre-split Deductions From the Current Calendar Year The purpose of this article is to show how to account for an agent being overpaid, in the current calendar year, when pre-split amounts were under collected. Note: Do not add new commission records in sales that closed in a previous calendar year. This will alter the agent's 1099 value and will need to send the agent and the IRS a corrected 1099 for that year.  If an agent was overpaid because pre-split am"
---
