---
title: Accounting - Post-split Deductions that Reset on Agent's Anniversary Date
---
...
If the TRANS post-split deduction needs to reset on May 1st, instead of January 1st, the **Anniv Reset?** box should be checked.
