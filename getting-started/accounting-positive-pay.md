---
title: "Accounting - Positive Pay"
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/15723183"
tags: ["Getting Started"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Accounting - Positive Pay | Constellation1 Customer Hub The purpose of this article is to define the purpose of Positive Pay and how to set it up"
long_description: "Accounting - Positive Pay | Constellation1 Customer Hub The purpose of this article is to define the purpose of Positive Pay and how to set it up. Positive Pay is a system used by banks to detect fraud. Positive Pay works by matching the dollar amount of each check, the check number and the account number that is presented for payment against checks that have been previously authorized and issued by your company.  To enable positive pay functionality, navigate to GL > Setup > Chart of Accounts L"
---
