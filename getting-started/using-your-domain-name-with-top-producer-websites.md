...
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/27536466"
tags: ["Getting Started"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Using Your Domain Name With Top Producer Websites Here are the steps to setup a domain name to point to a Top Producer Website and also to have the do"
long_description: "Using Your Domain Name With Top Producer Websites Here are the steps to setup a domain name to point to a Top Producer Website and also to have the domain appear as a secure site without having to purchase or install an SSL certificate. These steps will use a Godaddy account as an example. Log into Godaddy at https://www.godaddy.com/ and click Sign in (top right) or to go https://sso.godaddy.com/ Click My Account in the upper left area, then click Domains. From the Domain Portfolio, click on the"
---
