---
title: "Accounting – System Setting REPORTTIMEOUT"
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/14775967"
tags: ["Getting Started"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Accounting – System Setting REPORTTIMEOUT The purpose of this article is to provide information regarding system setting REPORTTIMEOUT"
long_description: "Accounting – System Setting REPORTTIMEOUT The purpose of this article is to provide information regarding system setting REPORTTIMEOUT. Because some reports take longer to process than others, you may occasionally face a timeout error when processing a report. The default time, for system setting REPORTTIMEOUT, is 60 seconds but can be changed as needed. If a report times out, close the report parameters tab for that report, navigate to System > Setup > System Settings and increase the Numeric V"
---
