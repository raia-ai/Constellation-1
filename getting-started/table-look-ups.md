---
title: "Table Look Ups"
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/13679805"
tags: ["Getting Started"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Table Look Ups | Constellation1 Customer Hub The Table Lookup feature can be used to add additional information to certain fields"
long_description: "Table Look Ups | Constellation1 Customer Hub The Table Lookup feature can be used to add additional information to certain fields. For example, conditions on transactions can be set up to include more detail, such as the type of condition. Please note that the system will only validate a particular field if at least one entry has been defined per field. The following is a list of some of the Table Look Up’s and a description of how they are used: Demographics The information configured here will"
---
