---
title: "Constellation1 Transactions Integration"
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/13585798"
tags: ["Getting Started"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Constellation1 Transactions Integration | Constellation1 Customer Hub This article outlines the setup process between Commissions and Constellation1 T"
long_description: "Constellation1 Transactions Integration | Constellation1 Customer Hub This article outlines the setup process between Commissions and Constellation1 Transactions accounts.  Navigate to Setup > Company Profile > Integration  In the MLS/TMS Status To Import section select the statuses for import or Add/Delete ones as needed.  Once the preferred statuses selected close and relaunch the Commissions application for new configuration to take effect.  Please note: Active = Listings and there is no logi"
---
...
**_Please note: Active = Listings and there is no logic to filter out "Expired" transactions, the Commissions application will import whatever transaction statuses are provided by Constellation1 Transactions._** 
