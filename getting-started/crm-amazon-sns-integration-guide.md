...
| isLead              | Boolean  | <p>If ever isLead = True, the lead will always be visible to assigned Owner and lead admins.   Once set to True, it cannot be changed.<br><br>If isLead is always False, the lead will only be visible to the assigned Member.</p> |
| referrerURL         | String   | Referring URL from previous domain                                                                                                                                                                                                 |
| originalReferrerURL | String   |                                                                                                                                                                                                                                    |
| timestampEntered    | DateTime | Creation date (UTC)                                                                                                                                                                                                                |
