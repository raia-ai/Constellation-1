---
title: "Accounting - Adding and Editing User Roles"
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/25331142"
tags: ["Getting Started"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Accounting - Adding and Editing User Roles The purpose of this article is to explain the purpose of a user role and show how to set up a new role or e"
long_description: "Accounting - Adding and Editing User Roles The purpose of this article is to explain the purpose of a user role and show how to set up a new role or edit an existing role.  When adding a new user to the Accounting program, each user will need to be assigned a User Role. A User Role defines which Module, a user will have access to, and which Processes, Reports, and/or Setup menu items the user will have access to in each module.  For example, in the screenshot below, there are three User Roles av"
---
