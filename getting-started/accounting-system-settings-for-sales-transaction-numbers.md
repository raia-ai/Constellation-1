---
title: "Accounting - System Settings for Sales Transaction Numbers"
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/25956607"
tags: ["Getting Started"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Accounting - System Settings for Sales Transaction Numbers The purpose of this article is point out some of the System Settings that can be used to co"
long_description: "Accounting - System Settings for Sales Transaction Numbers The purpose of this article is point out some of the System Settings that can be used to control how Trans #'s within sale transactions can be auto generated. To review system settings available, navigate to System > Setup > System Settings, then review the system settings shown below to determine which options may suite your business requirements.  AUTONMBR - Enabling this setting, by putting a checkmark in the Enabled? box, will result"
---
