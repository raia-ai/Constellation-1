---
title: "Accounting - Projects (Use and Configuration)"
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/14359770"
tags: ["Getting Started"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Accounting - Projects (Use and Configuration) The purpose of this article is to explain the purpose of projects and how to setup them up"
long_description: "Accounting - Projects (Use and Configuration) The purpose of this article is to explain the purpose of projects and how to setup them up. A project can serve as an additional filter on many reports from the Sales, Agents, Accounts Payable, and General Ledger modules. However, what sets the projects filter apart from other report filters is that it allows you to process various Income Statement reports by specific projects. For example, if your brokerage has exclusive rights to sell vacant lots i"
---
