...
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/14434648"
tags: ["Getting Started"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Accounting - General Journal Entries The purpose of this article is to show how to add, edit, copy, delete, and reverse an unposted general journal en"
long_description: "Accounting - General Journal Entries The purpose of this article is to show how to add, edit, copy, delete, and reverse an unposted general journal entry and how to copy or reverse a posted general journal entry.  Entering journal entries is the most common task in the General Ledger module. To add a journal entry, navigate to GL>>Processing>>General Journal Entries.  Click Add Enter a unique alphanumeric Journal Entry Number, up to sixteen characters  Consult with your CPA for a recommended nam"
---
