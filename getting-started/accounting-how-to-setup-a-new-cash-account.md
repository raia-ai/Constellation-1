...
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/14634481"
tags: ["Getting Started"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Accounting - How to Setup a New Cash Account The purpose of this article is to provide the necessary steps to setup a new cash account that will be us"
long_description: "Accounting - How to Setup a New Cash Account The purpose of this article is to provide the necessary steps to setup a new cash account that will be used to pay agents, vendors, and/or employees. Setup a new GL code.  Navigate to GL > Setup > Chart of Accounts and click Add. Select Current Assets from Account Subtype dropdown. Select Cash from Account Lookup Category dropdown. Enter Account Description. Enter a unique five digit GL Code. Enter Bank Account Information.  Bank Account Information i"
---
