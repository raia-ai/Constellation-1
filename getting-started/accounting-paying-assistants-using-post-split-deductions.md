---
title: "Accounting - Paying Assistants Using Post Split Deductions"
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/14096034"
tags: ["Getting Started"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Accounting - Paying Assistants Using Post Split Deductions The purpose of this article is to show how to pay an assistant from an agent's commission,"
long_description: "Accounting - Paying Assistants Using Post Split Deductions The purpose of this article is to show how to pay an assistant from an agent's commission, in stances when the assistant is not a licensed agent, and when the assistant is a licensed agent.  The first step to take, when an agent would like part of their agent split to be deducted to pay their assistant, is to setup a unique post-split. To setup a post-split deduction, navigate to Agents > Setup > Post-Split Deductions. Click Add Enter un"
---
