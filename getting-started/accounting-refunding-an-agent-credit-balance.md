...
* In the **Agent Charge Entries** section of the bill, click the green plus to select the agent from the **Agent** dropdown.&#x20;
  * Note the **Check Expense Entries** section of the bill is _**not**_ used when refunding agents. &#x20;
...
NOTE:  Refunding an agent's credit balance creates an agent charge that is _**not**_ considered to be a business expense for the agent.  To finish the refund process, you should navigate to **Agents > Processing > Agent Credits/Payments** to apply any unapplied amounts to the newly created agent charge. &#x20;
