---
title: How To Enable Click-to-Chat (Lead Generation Tool)
---
...
Here is an example of a Click to Chat feature shown on your Tour video, once you have enabled it.

![](https://constellation1.na3.teamsupport.com/api/attachments/image/2472652/1b79e173-e2c9-48fe-b8d3-2b357e65bbbb.png)

**Note:**

When a lead or potential client clicks Let’s Chat they will be prompted to provide their Name and Phone Number, initiating a real-time text conversation.

With our Zoom integration, you can simply text the word Zoom, and your personal meeting ID will automatically be shared with the client. This feature enables you to seamlessly transition from texting to a face-to-face conversation via a Zoom meeting
