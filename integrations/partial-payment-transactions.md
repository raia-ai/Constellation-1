---
title: "Partial Payment Transactions"
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/20499406"
tags: ["Integrations"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Partial Payment Transactions | Constellation1 Customer Hub A Partial Payment Transaction is used when commission is collected and paid in installments"
long_description: "Partial Payment Transactions | Constellation1 Customer Hub A Partial Payment Transaction is used when commission is collected and paid in installments such as a new construction/builder home or if the expected commission is not received in full. New Construction/Builder Transaction Typically, a new construction/builder transaction involves multiple payments of commission. See example below: A commission amount of $5000.00 when the agreement is firm. 50% of the remaining commission may be paid wh"
---
