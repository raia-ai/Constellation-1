...
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/19084225"
tags: ["Integrations"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Accounting - Fixing date discrepancies created from non-commission agent payment deposits (prior to November 2022) The purpose of this article is to p"
long_description: "Accounting - Fixing date discrepancies created from non-commission agent payment deposits (prior to November 2022) The purpose of this article is to provide the steps, that need to be taken, to correct differences in the date of a non-commission agent deposit, in the Bank module, and the agent payment record in the Agents module. Prior to Constellation1 Accounting program build 2022.11.21, it was possible, in some instances to cause theses dates to be out of sync. This problem becomes apparent w"
---
