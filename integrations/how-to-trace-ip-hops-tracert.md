---
title: "How To Trace IP Hops - Tracert"
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/14400257"
tags: ["Integrations"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "How To Trace IP Hops - Tracert Follow the below instructions on your computer to see how your ISP is routing you to the website"
long_description: "How To Trace IP Hops - Tracert Follow the below instructions on your computer to see how your ISP is routing you to the website. This can be useful in determining how areas on the website are determining your location. Note: Depending on router/ISP configurations you may not get all results returned when running this command. You may see several lines of '* * * Request Timed out'. Again this is no error on your part. For Windows - Click on start. Click in the search box. Then type cmd (or comman"
---
