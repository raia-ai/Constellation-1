---
title: "Layouts Best Practices"
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/14399838"
tags: ["Marketing & Leads"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Layouts Best Practices | Constellation1 Customer Hub Best Practice: Make JavaScript and CS:S external: 1"
long_description: "Layouts Best Practices | Constellation1 Customer Hub Best Practice: Make JavaScript and CS:S external: 1. Reusability: When the code is separated out, it can be reused by other layouts/code files if applicable. This makes the code reusable which leads to less overall code. 2. Maintainability: When the code is referenced, it tends to be easier to maintain since the code is stand alone. With duplicate code in multiple layouts, you have to deal with double the maintenance if a change needs to occur"
---
