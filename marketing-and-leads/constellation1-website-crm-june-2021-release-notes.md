...
_**Note:**_ _If an agent domain is not secured, **do not** check this box. Checking this box does not secure the domain. A security certificate will need to be issued for the domain prior to checking this box. If you have any questions, please contact your Constellation1 representative._
