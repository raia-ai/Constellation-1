...
This feature is also available to API users. Click [HERE](https://docs.constellation1.com/rest-authentication-header/rest-group-management-header/rest-creategroup) to view the CreateGroup API documentation and [HERE](https://docs.constellation1.com/api/api-reference-overview/group-management/updategroup) to view the UpdateGroup API documentation.

Click [HERE](https://docs.constellation1.com/groupview) to view the API RequestResponse in Appendix B.&#x20;
