...
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/13677731"
tags: ["Reporting & Analytics"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Entering Transactions | Constellation1 Customer Hub This article will walk you through the steps to enter a new transaction"
long_description: "Entering Transactions | Constellation1 Customer Hub This article will walk you through the steps to enter a new transaction. Please note that all parties, buyer, seller, and co broker must be added to each transaction to be able to successfully close. Upon login, the system will default to the Transaction screen in Search mode At the bottom right of your screen, arrows support navigating to sequentially numbered transactions The Main Tab of the Transaction To enter a transaction, select the New"
---

# Entering Transactions | Constellation1 Customer Hub

This article will walk you through the steps to enter a new transaction. Please note that all parties, buyer, seller, and co broker must be added to each transaction to be able to successfully close.
...
![](https://constellation1.na3.teamsupport.com/api/attachments/image/2472652/26696d9e-8e99-4ac9-a035-7920507aba3d.png)
...
*   Or enter the gross commission by using the Override option
...
*   When only representing one side of the transaction, the Co-Brokerage must be added via the Lookup option, you can also create a placeholder of UNKNOWN, but a Co-Broker must be added to successfully close a transaction
