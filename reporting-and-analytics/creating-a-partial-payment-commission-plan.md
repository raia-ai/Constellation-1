---
title: "Creating a Partial Payment Commission Plan"
source: "https://constellation1.na3.teamsupport.com/knowledgeBase/13686976"
tags: ["Reporting & Analytics"]
version: "1.0"
last_updated: "2025-11-18"
short_description: "Creating a Partial Payment Commission Plan A Partial Payment Commission Calculation means users can allocate Broker Flat Fees and Other Fees to partia"
long_description: "Creating a Partial Payment Commission Plan A Partial Payment Commission Calculation means users can allocate Broker Flat Fees and Other Fees to partial payment transactions (20125613A, 20125613B, etc.) that will allow the user to pre-define specific Fee amounts that do not use the existing proportional calculations.  Sample Partial Payment Commission plan:  In the sample above, Partial Payment Transaction A will deduct 10% + $500.00 as the Broker Portion, Partial Payment B will deduct 10% + $250"
---

# Creating a Partial Payment Commission Plan

A Partial Payment Commission Calculation means users can allocate Broker Flat Fees and Other Fees to partial payment transactions (20125613A, 20125613B, etc.) that will allow the user to pre-define specific Fee amounts that do not use the existing proportional calculations. 

Sample Partial Payment Commission plan: 

![](https://app.na3.teamsupport.com/Wiki/WikiDocs/2472652/images/creatingapartialpayment1.png)

![](https://app.na3.teamsupport.com/Wiki/WikiDocs/2472652/images/KB-CreatingPartialPayments/creatingapartialpayment2.png)

![](https://app.na3.teamsupport.com/Wiki/WikiDocs/2472652/images/KB-CreatingPartialPayments/creatingapartialpayment3.png) 
...
*   Users will assign the “Partial Payment” commission plan to the “Main” partial payment transaction once the first payment has been created
...
*   You will ONLY be able to override the commission plan with this type of partial payment transaction, otherwise C1 Commissions does not allow for this functionality.
